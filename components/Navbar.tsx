...
const Navbar = () => {
  ...
  return (
    <nav className="fixed left-1/2 transform -translate-x-1/2 w-[90vw] flex items-center box-border justify-between md:px-6 px-4 py-2 md:py-4 rounded-full border border-gray-700 bg-black z-50 mt-3">
      <Link href="/">
        <Image
          src={logo}
          alt="logo"
      ...
      <div className="hidden md:flex text-sm md:text-base space-x-2 md:space-x-4 font-serif">
        <Link href="/">
          <Button>Home</Button>
        </Link>
        <Link href="/about-us">
