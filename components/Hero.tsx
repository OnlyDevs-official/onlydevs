  ...
  return (
    <>
      <div className="min-h-screen flex flex-col justify-center items-center  text-white px-4">
        <motion.h1
          className="text-4xl md:text-8xl font-bold aeonic-bold kerning-tightest text-center mb-8 mt-36"
...
const AnimatedButton = () => {
  ...
  return (
    <div className="my-6">
      <button
        className="border border-white rounded-full flex items-center pl-7 py-3 cursor-pointer transition-all duration-300  hover:bg-opacity-10 w-[80px] h-[90px]"
