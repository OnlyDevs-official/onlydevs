    ...
    >
      <div className="flex flex-col lg:flex-row justify-between items-center">
        <div className="w-full lg:w-1/2 mb-8 lg:mb-0">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 abril-fatface-regular">
        ...
        <div className="w-full lg:w-1/3 text-center">
          <h3 className="text-xl sm:text-2xl font-semibold text-white mb-4 abril-fatface-regular">
            Join the community
          </h3>
